...
//
// @dart = 2.12
// ignore_for_file: annotate_overrides,camel_case_types,unnecessary_const,non_constant_identifier_names,library_prefixes,unused_import,unused_shown_name,return_of_invalid_type,unnecessary_this,prefer_final_fields, constant_identifier_names, unnecessary_import
...
import 'lightning.pbenum.dart' as $0;
...
class SendPaymentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$0.FeatureBit>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'destFeatures',
        $pb.PbFieldType.PE,
        valueOf: $0.FeatureBit.valueOf,
        enumValues: $0.FeatureBit.values)
    ..a<$core.int>(
        17,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  SendPaymentRequest copyWith(void Function(SendPaymentRequest) updates) =>
      super.copyWith((message) => updates(message as SendPaymentRequest))
          as SendPaymentRequest; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static SendPaymentRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SendPaymentRequest>(create);
  ...
  @$pb.TagNumber(7)
  set feeLimitSat($fixnum.Int64 v) {
    $_setInt64(6, v);
  }
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  set outgoingChanId($fixnum.Int64 v) {
    $_setInt64(7, v);
  }
  ...
  @$pb.TagNumber(11)
  $core.Map<$fixnum.Int64, $core.List<$core.int>> get destCustomRecords =>
      $_getMap(10);

  @$pb.TagNumber(12)
  $fixnum.Int64 get amtMsat => $_getI64(11);
  @$pb.TagNumber(12)
  set amtMsat($fixnum.Int64 v) {
    $_setInt64(11, v);
  }
  ...
  @$pb.TagNumber(18)
  set noInflightUpdates($core.bool v) {
    $_setBool(17, v);
  }
  ...
  @$pb.TagNumber(21)
  set maxShardSizeMsat($fixnum.Int64 v) {
    $_setInt64(20, v);
  }
...
class TrackPaymentRequest extends $pb.GeneratedMessage {
  ...
  TrackPaymentRequest copyWith(void Function(TrackPaymentRequest) updates) =>
      super.copyWith((message) => updates(message as TrackPaymentRequest))
          as TrackPaymentRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TrackPaymentRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TrackPaymentRequest>(create);
...
class RouteFeeRequest extends $pb.GeneratedMessage {
  ...
  RouteFeeRequest copyWith(void Function(RouteFeeRequest) updates) =>
      super.copyWith((message) => updates(message as RouteFeeRequest))
          as RouteFeeRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static RouteFeeRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RouteFeeRequest>(create);
...
class RouteFeeResponse extends $pb.GeneratedMessage {
  ...
  RouteFeeResponse copyWith(void Function(RouteFeeResponse) updates) =>
      super.copyWith((message) => updates(message as RouteFeeResponse))
          as RouteFeeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static RouteFeeResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RouteFeeResponse>(create);
  static RouteFeeResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get routingFeeMsat => $_getI64(0);
  @$pb.TagNumber(1)
  set routingFeeMsat($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set timeLockDelay($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
...
class SendToRouteRequest extends $pb.GeneratedMessage {
  ...
  SendToRouteRequest copyWith(void Function(SendToRouteRequest) updates) =>
      super.copyWith((message) => updates(message as SendToRouteRequest))
          as SendToRouteRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static SendToRouteRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SendToRouteRequest>(create);
...
class SendToRouteResponse extends $pb.GeneratedMessage {
  ...
  SendToRouteResponse copyWith(void Function(SendToRouteResponse) updates) =>
      super.copyWith((message) => updates(message as SendToRouteResponse))
          as SendToRouteResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static SendToRouteResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SendToRouteResponse>(create);
...
class ResetMissionControlRequest extends $pb.GeneratedMessage {
  ...
  ResetMissionControlRequest copyWith(
      ...
      super.copyWith(
          ...
          as ResetMissionControlRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ResetMissionControlRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ResetMissionControlRequest>(create);
...
class ResetMissionControlResponse extends $pb.GeneratedMessage {
  ...
  ResetMissionControlResponse copyWith(
      ...
      super.copyWith(
          ...
          as ResetMissionControlResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ResetMissionControlResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ResetMissionControlResponse>(create);
...
class QueryMissionControlRequest extends $pb.GeneratedMessage {
  ...
  QueryMissionControlRequest copyWith(
      ...
      super.copyWith(
          ...
          as QueryMissionControlRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static QueryMissionControlRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryMissionControlRequest>(create);
...
class QueryMissionControlResponse extends $pb.GeneratedMessage {
  ...
  QueryMissionControlResponse copyWith(
      ...
      super.copyWith(
          ...
          as QueryMissionControlResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static QueryMissionControlResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryMissionControlResponse>(create);
...
class XImportMissionControlRequest extends $pb.GeneratedMessage {
  ...
  factory XImportMissionControlRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory XImportMissionControlRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  XImportMissionControlRequest clone() =>
      XImportMissionControlRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  XImportMissionControlRequest copyWith(
          void Function(XImportMissionControlRequest) updates) =>
      super.copyWith(
              (message) => updates(message as XImportMissionControlRequest))
          as XImportMissionControlRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static XImportMissionControlRequest create() =>
      XImportMissionControlRequest._();
  XImportMissionControlRequest createEmptyInstance() => create();
  static $pb.PbList<XImportMissionControlRequest> createRepeated() =>
      $pb.PbList<XImportMissionControlRequest>();
  @$core.pragma('dart2js:noInline')
  static XImportMissionControlRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<XImportMissionControlRequest>(create);
...
class XImportMissionControlResponse extends $pb.GeneratedMessage {
  ...
  factory XImportMissionControlResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory XImportMissionControlResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  XImportMissionControlResponse clone() =>
      XImportMissionControlResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  XImportMissionControlResponse copyWith(
          void Function(XImportMissionControlResponse) updates) =>
      super.copyWith(
              (message) => updates(message as XImportMissionControlResponse))
          as XImportMissionControlResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static XImportMissionControlResponse create() =>
      XImportMissionControlResponse._();
  XImportMissionControlResponse createEmptyInstance() => create();
  static $pb.PbList<XImportMissionControlResponse> createRepeated() =>
      $pb.PbList<XImportMissionControlResponse>();
  @$core.pragma('dart2js:noInline')
  static XImportMissionControlResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<XImportMissionControlResponse>(create);
...
class PairHistory extends $pb.GeneratedMessage {
  ...
  PairHistory copyWith(void Function(PairHistory) updates) =>
      super.copyWith((message) => updates(message as PairHistory))
          as PairHistory; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PairHistory getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PairHistory>(create);
...
class PairData extends $pb.GeneratedMessage {
  ...
  PairData copyWith(void Function(PairData) updates) =>
      super.copyWith((message) => updates(message as PairData))
          as PairData; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PairData getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PairData>(create);
  static PairData? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get failTime => $_getI64(0);
  @$pb.TagNumber(1)
  set failTime($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
  ...
  @$pb.TagNumber(4)
  set failAmtMsat($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
  ...
  @$pb.TagNumber(5)
  set successTime($fixnum.Int64 v) {
    $_setInt64(3, v);
  }
  ...
  @$pb.TagNumber(6)
  set successAmtSat($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
  ...
  @$pb.TagNumber(7)
  set successAmtMsat($fixnum.Int64 v) {
    $_setInt64(5, v);
  }
...
class GetMissionControlConfigRequest extends $pb.GeneratedMessage {
  ...
  factory GetMissionControlConfigRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetMissionControlConfigRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  GetMissionControlConfigRequest clone() =>
      GetMissionControlConfigRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetMissionControlConfigRequest copyWith(
          void Function(GetMissionControlConfigRequest) updates) =>
      super.copyWith(
              (message) => updates(message as GetMissionControlConfigRequest))
          as GetMissionControlConfigRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetMissionControlConfigRequest create() =>
      GetMissionControlConfigRequest._();
  GetMissionControlConfigRequest createEmptyInstance() => create();
  static $pb.PbList<GetMissionControlConfigRequest> createRepeated() =>
      $pb.PbList<GetMissionControlConfigRequest>();
  @$core.pragma('dart2js:noInline')
  static GetMissionControlConfigRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetMissionControlConfigRequest>(create);
...
class GetMissionControlConfigResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'routerrpc'),
      createEmptyInstance: create)
    ..aOM<MissionControlConfig>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'config',
        subBuilder: MissionControlConfig.create)
    ..hasRequiredFields = false;
  ...
  factory GetMissionControlConfigResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetMissionControlConfigResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  GetMissionControlConfigResponse clone() =>
      GetMissionControlConfigResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetMissionControlConfigResponse copyWith(
          void Function(GetMissionControlConfigResponse) updates) =>
      super.copyWith(
              (message) => updates(message as GetMissionControlConfigResponse))
          as GetMissionControlConfigResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetMissionControlConfigResponse create() =>
      GetMissionControlConfigResponse._();
  GetMissionControlConfigResponse createEmptyInstance() => create();
  static $pb.PbList<GetMissionControlConfigResponse> createRepeated() =>
      $pb.PbList<GetMissionControlConfigResponse>();
  @$core.pragma('dart2js:noInline')
  static GetMissionControlConfigResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetMissionControlConfigResponse>(
          create);
  ...
  @$pb.TagNumber(1)
  set config(MissionControlConfig v) {
    setField(1, v);
  }
...
class SetMissionControlConfigRequest extends $pb.GeneratedMessage {
  ...
  factory SetMissionControlConfigRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SetMissionControlConfigRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SetMissionControlConfigRequest clone() =>
      SetMissionControlConfigRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SetMissionControlConfigRequest copyWith(
          void Function(SetMissionControlConfigRequest) updates) =>
      super.copyWith(
              (message) => updates(message as SetMissionControlConfigRequest))
          as SetMissionControlConfigRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SetMissionControlConfigRequest create() =>
      SetMissionControlConfigRequest._();
  SetMissionControlConfigRequest createEmptyInstance() => create();
  static $pb.PbList<SetMissionControlConfigRequest> createRepeated() =>
      $pb.PbList<SetMissionControlConfigRequest>();
  @$core.pragma('dart2js:noInline')
  static SetMissionControlConfigRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SetMissionControlConfigRequest>(create);
...
class SetMissionControlConfigResponse extends $pb.GeneratedMessage {
  ...
  factory SetMissionControlConfigResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SetMissionControlConfigResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SetMissionControlConfigResponse clone() =>
      SetMissionControlConfigResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SetMissionControlConfigResponse copyWith(
          void Function(SetMissionControlConfigResponse) updates) =>
      super.copyWith(
              (message) => updates(message as SetMissionControlConfigResponse))
          as SetMissionControlConfigResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SetMissionControlConfigResponse create() =>
      SetMissionControlConfigResponse._();
  SetMissionControlConfigResponse createEmptyInstance() => create();
  static $pb.PbList<SetMissionControlConfigResponse> createRepeated() =>
      $pb.PbList<SetMissionControlConfigResponse>();
  @$core.pragma('dart2js:noInline')
  static SetMissionControlConfigResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SetMissionControlConfigResponse>(
          create);
...
class MissionControlConfig extends $pb.GeneratedMessage {
  ...
  factory MissionControlConfig({
    ...
    if (halfLifeSeconds != null) {
      _result.halfLifeSeconds = halfLifeSeconds;
    }
    if (hopProbability != null) {
      _result.hopProbability = hopProbability;
    }
    if (weight != null) {
      _result.weight = weight;
    }
    if (maximumPaymentResults != null) {
      _result.maximumPaymentResults = maximumPaymentResults;
    }
    if (minimumFailureRelaxInterval != null) {
      _result.minimumFailureRelaxInterval = minimumFailureRelaxInterval;
    }
    return _result;
  }
  factory MissionControlConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MissionControlConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  MissionControlConfig clone() =>
      MissionControlConfig()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MissionControlConfig copyWith(void Function(MissionControlConfig) updates) =>
      super.copyWith((message) => updates(message as MissionControlConfig))
          as MissionControlConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MissionControlConfig create() => MissionControlConfig._();
  MissionControlConfig createEmptyInstance() => create();
  static $pb.PbList<MissionControlConfig> createRepeated() =>
      $pb.PbList<MissionControlConfig>();
  @$core.pragma('dart2js:noInline')
  static MissionControlConfig getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MissionControlConfig>(create);
  static MissionControlConfig? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get halfLifeSeconds => $_getI64(0);
  @$pb.TagNumber(1)
  set halfLifeSeconds($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
  ...
  @$pb.TagNumber(1)
  void clearHalfLifeSeconds() => clearField(1);

  @$pb.TagNumber(2)
  $core.double get hopProbability => $_getN(1);
  @$pb.TagNumber(2)
  set hopProbability($core.double v) {
    $_setFloat(1, v);
  }
  ...
  @$pb.TagNumber(2)
  void clearHopProbability() => clearField(2);
  ...
  @$pb.TagNumber(4)
  set maximumPaymentResults($core.int v) {
  ...
  @$pb.TagNumber(4)
  void clearMaximumPaymentResults() => clearField(4);

  @$pb.TagNumber(5)
  $fixnum.Int64 get minimumFailureRelaxInterval => $_getI64(4);
  @$pb.TagNumber(5)
  set minimumFailureRelaxInterval($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
  ...
  @$pb.TagNumber(5)
  void clearMinimumFailureRelaxInterval() => clearField(5);
}
...
class QueryProbabilityRequest extends $pb.GeneratedMessage {
  ...
  QueryProbabilityRequest copyWith(
      ...
      super.copyWith((message) => updates(message as QueryProbabilityRequest))
          as QueryProbabilityRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static QueryProbabilityRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryProbabilityRequest>(create);
...
class QueryProbabilityResponse extends $pb.GeneratedMessage {
  ...
  QueryProbabilityResponse copyWith(
      ...
      super.copyWith((message) => updates(message as QueryProbabilityResponse))
          as QueryProbabilityResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static QueryProbabilityResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryProbabilityResponse>(create);
...
class BuildRouteRequest extends $pb.GeneratedMessage {
  ...
  BuildRouteRequest copyWith(void Function(BuildRouteRequest) updates) =>
      super.copyWith((message) => updates(message as BuildRouteRequest))
          as BuildRouteRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BuildRouteRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildRouteRequest>(create);
...
class BuildRouteResponse extends $pb.GeneratedMessage {
  ...
  BuildRouteResponse copyWith(void Function(BuildRouteResponse) updates) =>
      super.copyWith((message) => updates(message as BuildRouteResponse))
          as BuildRouteResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BuildRouteResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildRouteResponse>(create);
...
class SubscribeHtlcEventsRequest extends $pb.GeneratedMessage {
  ...
  factory SubscribeHtlcEventsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SubscribeHtlcEventsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SubscribeHtlcEventsRequest clone() =>
      SubscribeHtlcEventsRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SubscribeHtlcEventsRequest copyWith(
          void Function(SubscribeHtlcEventsRequest) updates) =>
      super.copyWith(
              (message) => updates(message as SubscribeHtlcEventsRequest))
          as SubscribeHtlcEventsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<SubscribeHtlcEventsRequest> createRepeated() =>
      $pb.PbList<SubscribeHtlcEventsRequest>();
  @$core.pragma('dart2js:noInline')
  static SubscribeHtlcEventsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SubscribeHtlcEventsRequest>(create);
...
class HtlcEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<HtlcEvent_EventType>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'eventType',
        $pb.PbFieldType.OE,
        defaultOrMaker: HtlcEvent_EventType.UNKNOWN,
        valueOf: HtlcEvent_EventType.valueOf,
        enumValues: HtlcEvent_EventType.values)
    ..aOM<ForwardEvent>(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'forwardEvent',
        subBuilder: ForwardEvent.create)
    ..aOM<ForwardFailEvent>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'forwardFailEvent',
        subBuilder: ForwardFailEvent.create)
    ..aOM<SettleEvent>(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'settleEvent',
        subBuilder: SettleEvent.create)
    ..aOM<LinkFailEvent>(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'linkFailEvent',
        subBuilder: LinkFailEvent.create)
    ..hasRequiredFields = false;
  ...
  factory HtlcEvent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory HtlcEvent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  HtlcEvent copyWith(void Function(HtlcEvent) updates) =>
      super.copyWith((message) => updates(message as HtlcEvent))
          as HtlcEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static HtlcEvent getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HtlcEvent>(create);
  ...
  @$pb.TagNumber(1)
  set incomingChannelId($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set outgoingChannelId($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set incomingHtlcId($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set outgoingHtlcId($fixnum.Int64 v) {
    $_setInt64(3, v);
  }
  ...
  @$pb.TagNumber(5)
  set timestampNs($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
  ...
  @$pb.TagNumber(6)
  set eventType(HtlcEvent_EventType v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(7)
  set forwardEvent(ForwardEvent v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(8)
  set forwardFailEvent(ForwardFailEvent v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(10)
  set linkFailEvent(LinkFailEvent v) {
    setField(10, v);
  }
...
class HtlcInfo extends $pb.GeneratedMessage {
  ...
  factory HtlcInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory HtlcInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  HtlcInfo copyWith(void Function(HtlcInfo) updates) =>
      super.copyWith((message) => updates(message as HtlcInfo))
          as HtlcInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static HtlcInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HtlcInfo>(create);
  static HtlcInfo? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get incomingTimelock => $_getIZ(0);
  @$pb.TagNumber(1)
  set incomingTimelock($core.int v) {
  ...
  @$pb.TagNumber(2)
  set outgoingTimelock($core.int v) {
  ...
  @$pb.TagNumber(3)
  set incomingAmtMsat($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set outgoingAmtMsat($fixnum.Int64 v) {
    $_setInt64(3, v);
  }
...
class ForwardEvent extends $pb.GeneratedMessage {
  ...
  factory ForwardEvent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ForwardEvent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ForwardEvent copyWith(void Function(ForwardEvent) updates) =>
      super.copyWith((message) => updates(message as ForwardEvent))
          as ForwardEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ForwardEvent create() => ForwardEvent._();
  ForwardEvent createEmptyInstance() => create();
  static $pb.PbList<ForwardEvent> createRepeated() =>
      $pb.PbList<ForwardEvent>();
  @$core.pragma('dart2js:noInline')
  static ForwardEvent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForwardEvent>(create);
...
class ForwardFailEvent extends $pb.GeneratedMessage {
  ...
  factory ForwardFailEvent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ForwardFailEvent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ForwardFailEvent copyWith(void Function(ForwardFailEvent) updates) =>
      super.copyWith((message) => updates(message as ForwardFailEvent))
          as ForwardFailEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ForwardFailEvent create() => ForwardFailEvent._();
  ForwardFailEvent createEmptyInstance() => create();
  static $pb.PbList<ForwardFailEvent> createRepeated() =>
      $pb.PbList<ForwardFailEvent>();
  @$core.pragma('dart2js:noInline')
  static ForwardFailEvent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForwardFailEvent>(create);
...
class SettleEvent extends $pb.GeneratedMessage {
  ...
  factory SettleEvent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SettleEvent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SettleEvent copyWith(void Function(SettleEvent) updates) =>
      super.copyWith((message) => updates(message as SettleEvent))
          as SettleEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static SettleEvent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SettleEvent>(create);
...
class LinkFailEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<HtlcInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'info',
        subBuilder: HtlcInfo.create)
    ..e<$0.Failure_FailureCode>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'wireFailure',
        $pb.PbFieldType.OE,
        defaultOrMaker: $0.Failure_FailureCode.RESERVED,
        valueOf: $0.Failure_FailureCode.valueOf,
        enumValues: $0.Failure_FailureCode.values)
    ..e<FailureDetail>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'failureDetail',
        $pb.PbFieldType.OE,
        defaultOrMaker: FailureDetail.UNKNOWN,
        valueOf: FailureDetail.valueOf,
        enumValues: FailureDetail.values)
    ..aOS(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory LinkFailEvent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LinkFailEvent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LinkFailEvent copyWith(void Function(LinkFailEvent) updates) =>
      super.copyWith((message) => updates(message as LinkFailEvent))
          as LinkFailEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static LinkFailEvent create() => LinkFailEvent._();
  LinkFailEvent createEmptyInstance() => create();
  static $pb.PbList<LinkFailEvent> createRepeated() =>
      $pb.PbList<LinkFailEvent>();
  @$core.pragma('dart2js:noInline')
  static LinkFailEvent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LinkFailEvent>(create);
  ...
  @$pb.TagNumber(2)
  set wireFailure($0.Failure_FailureCode v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set failureDetail(FailureDetail v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(4)
  set failureString($core.String v) {
    $_setString(3, v);
  }
...
class PaymentStatus extends $pb.GeneratedMessage {
  ...
  PaymentStatus copyWith(void Function(PaymentStatus) updates) =>
      super.copyWith((message) => updates(message as PaymentStatus))
          as PaymentStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PaymentStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PaymentStatus>(create);
...
class CircuitKey extends $pb.GeneratedMessage {
  ...
  factory CircuitKey.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CircuitKey.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CircuitKey copyWith(void Function(CircuitKey) updates) =>
      super.copyWith((message) => updates(message as CircuitKey))
          as CircuitKey; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CircuitKey getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CircuitKey>(create);
  static CircuitKey? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get chanId => $_getI64(0);
  @$pb.TagNumber(1)
  set chanId($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
...
class ForwardHtlcInterceptRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$fixnum.Int64, $core.List<$core.int>>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'customRecords',
        entryClassName: 'ForwardHtlcInterceptRequest.CustomRecordsEntry',
        keyFieldType: $pb.PbFieldType.OU6,
        valueFieldType: $pb.PbFieldType.OY,
        packageName: const $pb.PackageName('routerrpc'))
    ..a<$core.List<$core.int>>(
  ...
  factory ForwardHtlcInterceptRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ForwardHtlcInterceptRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ForwardHtlcInterceptRequest clone() =>
      ForwardHtlcInterceptRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ForwardHtlcInterceptRequest copyWith(
          void Function(ForwardHtlcInterceptRequest) updates) =>
      super.copyWith(
              (message) => updates(message as ForwardHtlcInterceptRequest))
          as ForwardHtlcInterceptRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ForwardHtlcInterceptRequest create() =>
      ForwardHtlcInterceptRequest._();
  ForwardHtlcInterceptRequest createEmptyInstance() => create();
  static $pb.PbList<ForwardHtlcInterceptRequest> createRepeated() =>
      $pb.PbList<ForwardHtlcInterceptRequest>();
  @$core.pragma('dart2js:noInline')
  static ForwardHtlcInterceptRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForwardHtlcInterceptRequest>(create);
  static ForwardHtlcInterceptRequest? _defaultInstance;

  @$pb.TagNumber(1)
  CircuitKey get incomingCircuitKey => $_getN(0);
  @$pb.TagNumber(1)
  set incomingCircuitKey(CircuitKey v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set outgoingAmountMsat($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
  ...
  @$pb.TagNumber(5)
  set incomingAmountMsat($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
  ...
  @$pb.TagNumber(7)
  set outgoingRequestedChanId($fixnum.Int64 v) {
    $_setInt64(6, v);
  }
  ...
  @$pb.TagNumber(8)
  $core.Map<$fixnum.Int64, $core.List<$core.int>> get customRecords =>
      $_getMap(7);

  @$pb.TagNumber(9)
  $core.List<$core.int> get onionBlob => $_getN(8);
  @$pb.TagNumber(9)
  set onionBlob($core.List<$core.int> v) {
    $_setBytes(8, v);
  }
...
class ForwardHtlcInterceptResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<CircuitKey>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'incomingCircuitKey',
        subBuilder: CircuitKey.create)
    ..e<ResolveHoldForwardAction>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'action',
        $pb.PbFieldType.OE,
        defaultOrMaker: ResolveHoldForwardAction.SETTLE,
        valueOf: ResolveHoldForwardAction.valueOf,
        enumValues: ResolveHoldForwardAction.values)
    ..a<$core.List<$core.int>>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory ForwardHtlcInterceptResponse({
    ...
    $0.Failure_FailureCode? failureCode,
  }) {
    final _result = create();
    if (incomingCircuitKey != null) {
      _result.incomingCircuitKey = incomingCircuitKey;
  ...
  factory ForwardHtlcInterceptResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ForwardHtlcInterceptResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ForwardHtlcInterceptResponse clone() =>
      ForwardHtlcInterceptResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ForwardHtlcInterceptResponse copyWith(
          void Function(ForwardHtlcInterceptResponse) updates) =>
      super.copyWith(
              (message) => updates(message as ForwardHtlcInterceptResponse))
          as ForwardHtlcInterceptResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ForwardHtlcInterceptResponse create() =>
      ForwardHtlcInterceptResponse._();
  ForwardHtlcInterceptResponse createEmptyInstance() => create();
  static $pb.PbList<ForwardHtlcInterceptResponse> createRepeated() =>
      $pb.PbList<ForwardHtlcInterceptResponse>();
  @$core.pragma('dart2js:noInline')
  static ForwardHtlcInterceptResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForwardHtlcInterceptResponse>(create);
  ...
  @$pb.TagNumber(2)
  set action(ResolveHoldForwardAction v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set failureMessage($core.List<$core.int> v) {
    $_setBytes(3, v);
  }
  ...
  @$pb.TagNumber(4)
  void clearFailureMessage() => clearField(4);

  @$pb.TagNumber(5)
  $0.Failure_FailureCode get failureCode => $_getN(4);
  @$pb.TagNumber(5)
  set failureCode($0.Failure_FailureCode v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  void clearFailureCode() => clearField(5);
}
...
class UpdateChanStatusRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.ChannelPoint>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'chanPoint',
        subBuilder: $0.ChannelPoint.create)
    ..e<ChanStatusAction>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'action',
        $pb.PbFieldType.OE,
        defaultOrMaker: ChanStatusAction.ENABLE,
        valueOf: ChanStatusAction.valueOf,
        enumValues: ChanStatusAction.values)
    ..hasRequiredFields = false;

  UpdateChanStatusRequest._() : super();
  factory UpdateChanStatusRequest({
    $0.ChannelPoint? chanPoint,
  ...
  factory UpdateChanStatusRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UpdateChanStatusRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  UpdateChanStatusRequest clone() =>
      UpdateChanStatusRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UpdateChanStatusRequest copyWith(
          void Function(UpdateChanStatusRequest) updates) =>
      super.copyWith((message) => updates(message as UpdateChanStatusRequest))
          as UpdateChanStatusRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UpdateChanStatusRequest create() => UpdateChanStatusRequest._();
  UpdateChanStatusRequest createEmptyInstance() => create();
  static $pb.PbList<UpdateChanStatusRequest> createRepeated() =>
      $pb.PbList<UpdateChanStatusRequest>();
  @$core.pragma('dart2js:noInline')
  static UpdateChanStatusRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UpdateChanStatusRequest>(create);
  static UpdateChanStatusRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $0.ChannelPoint get chanPoint => $_getN(0);
  @$pb.TagNumber(1)
  set chanPoint($0.ChannelPoint v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $0.ChannelPoint ensureChanPoint() => $_ensure(0);

  @$pb.TagNumber(2)
  ChanStatusAction get action => $_getN(1);
  @$pb.TagNumber(2)
  set action(ChanStatusAction v) {
    setField(2, v);
  }
...
class UpdateChanStatusResponse extends $pb.GeneratedMessage {
  ...
  factory UpdateChanStatusResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UpdateChanStatusResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  UpdateChanStatusResponse clone() =>
      UpdateChanStatusResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UpdateChanStatusResponse copyWith(
          void Function(UpdateChanStatusResponse) updates) =>
      super.copyWith((message) => updates(message as UpdateChanStatusResponse))
          as UpdateChanStatusResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UpdateChanStatusResponse create() => UpdateChanStatusResponse._();
  UpdateChanStatusResponse createEmptyInstance() => create();
  static $pb.PbList<UpdateChanStatusResponse> createRepeated() =>
      $pb.PbList<UpdateChanStatusResponse>();
  @$core.pragma('dart2js:noInline')
  static UpdateChanStatusResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UpdateChanStatusResponse>(create);
