...
final $typed_data.Uint8List walletStateDescriptor = $convert.base64Decode(
    'CgtXYWxsZXRTdGF0ZRIQCgxOT05fRVhJU1RJTkcQABIKCgZMT0NLRUQQARIMCghVTkxPQ0tFRBACEg4KClJQQ19BQ1RJVkUQAxIRCg1TRVJWRVJfQUNUSVZFEAQSFQoQV0FJVElOR19UT19TVEFSVBD/AQ==');
...
final $typed_data.Uint8List subscribeStateRequestDescriptor =
    $convert.base64Decode('ChVTdWJzY3JpYmVTdGF0ZVJlcXVlc3Q=');
...
final $typed_data.Uint8List subscribeStateResponseDescriptor =
    $convert.base64Decode(
        'ChZTdWJzY3JpYmVTdGF0ZVJlc3BvbnNlEigKBXN0YXRlGAEgASgOMhIubG5ycGMuV2FsbGV0U3RhdGVSBXN0YXRl');
...
final $typed_data.Uint8List getStateRequestDescriptor =
    $convert.base64Decode('Cg9HZXRTdGF0ZVJlcXVlc3Q=');
...
final $typed_data.Uint8List getStateResponseDescriptor = $convert.base64Decode(
    'ChBHZXRTdGF0ZVJlc3BvbnNlEigKBXN0YXRlGAEgASgOMhIubG5ycGMuV2FsbGV0U3RhdGVSBXN0YXRl');
