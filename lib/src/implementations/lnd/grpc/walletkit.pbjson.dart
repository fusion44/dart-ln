...
const AddressType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'HYBRID_NESTED_WITNESS_PUBKEY_HASH', '2': 3},
...
final $typed_data.Uint8List addressTypeDescriptor = $convert.base64Decode(
    'CgtBZGRyZXNzVHlwZRILCgdVTktOT1dOEAASFwoTV0lUTkVTU19QVUJLRVlfSEFTSBABEh4KGk5FU1RFRF9XSVRORVNTX1BVQktFWV9IQVNIEAISJQohSFlCUklEX05FU1RFRF9XSVRORVNTX1BVQktFWV9IQVNIEAMSEgoOVEFQUk9PVF9QVUJLRVkQBA==');
...
final $typed_data.Uint8List witnessTypeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listUnspentRequestDescriptor = $convert.base64Decode(
    'ChJMaXN0VW5zcGVudFJlcXVlc3QSGwoJbWluX2NvbmZzGAEgASgFUghtaW5Db25mcxIbCgltYXhfY29uZnMYAiABKAVSCG1heENvbmZzEhgKB2FjY291bnQYAyABKAlSB2FjY291bnQSKQoQdW5jb25maXJtZWRfb25seRgEIAEoCFIPdW5jb25maXJtZWRPbmx5');
...
final $typed_data.Uint8List listUnspentResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0VW5zcGVudFJlc3BvbnNlEiEKBXV0eG9zGAEgAygLMgsubG5ycGMuVXR4b1IFdXR4b3M=');
...
final $typed_data.Uint8List leaseOutputRequestDescriptor = $convert.base64Decode(
    'ChJMZWFzZU91dHB1dFJlcXVlc3QSDgoCaWQYASABKAxSAmlkEisKCG91dHBvaW50GAIgASgLMg8ubG5ycGMuT3V0UG9pbnRSCG91dHBvaW50Ei0KEmV4cGlyYXRpb25fc2Vjb25kcxgDIAEoBFIRZXhwaXJhdGlvblNlY29uZHM=');
...
final $typed_data.Uint8List leaseOutputResponseDescriptor = $convert.base64Decode(
    'ChNMZWFzZU91dHB1dFJlc3BvbnNlEh4KCmV4cGlyYXRpb24YASABKARSCmV4cGlyYXRpb24=');
...
final $typed_data.Uint8List releaseOutputRequestDescriptor = $convert.base64Decode(
    'ChRSZWxlYXNlT3V0cHV0UmVxdWVzdBIOCgJpZBgBIAEoDFICaWQSKwoIb3V0cG9pbnQYAiABKAsyDy5sbnJwYy5PdXRQb2ludFIIb3V0cG9pbnQ=');
...
final $typed_data.Uint8List releaseOutputResponseDescriptor =
    $convert.base64Decode('ChVSZWxlYXNlT3V0cHV0UmVzcG9uc2U=');
...
final $typed_data.Uint8List keyReqDescriptor = $convert.base64Decode(
    'CgZLZXlSZXESKAoQa2V5X2Zpbmdlcl9wcmludBgBIAEoBVIOa2V5RmluZ2VyUHJpbnQSHQoKa2V5X2ZhbWlseRgCIAEoBVIJa2V5RmFtaWx5');
...
final $typed_data.Uint8List addrRequestDescriptor = $convert.base64Decode(
    'CgtBZGRyUmVxdWVzdBIYCgdhY2NvdW50GAEgASgJUgdhY2NvdW50EioKBHR5cGUYAiABKA4yFi53YWxsZXRycGMuQWRkcmVzc1R5cGVSBHR5cGUSFgoGY2hhbmdlGAMgASgIUgZjaGFuZ2U=');
...
final $typed_data.Uint8List addrResponseDescriptor =
    $convert.base64Decode('CgxBZGRyUmVzcG9uc2USEgoEYWRkchgBIAEoCVIEYWRkcg==');
...
const Account$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'master_key_fingerprint',
      '3': 4,
      '4': 1,
      '5': 12,
      '10': 'masterKeyFingerprint'
    },
    const {
      '1': 'derivation_path',
      '3': 5,
...
final $typed_data.Uint8List accountDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listAccountsRequestDescriptor = $convert.base64Decode(
    'ChNMaXN0QWNjb3VudHNSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSOQoMYWRkcmVzc190eXBlGAIgASgOMhYud2FsbGV0cnBjLkFkZHJlc3NUeXBlUgthZGRyZXNzVHlwZQ==');
...
final $typed_data.Uint8List listAccountsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0QWNjb3VudHNSZXNwb25zZRIuCghhY2NvdW50cxgBIAMoCzISLndhbGxldHJwYy5BY2NvdW50UghhY2NvdW50cw==');
...
final $typed_data.Uint8List importAccountRequestDescriptor = $convert.base64Decode(
    '');
...
const ImportAccountResponse$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'dry_run_external_addrs',
      '3': 2,
      '4': 3,
      '5': 9,
      '10': 'dryRunExternalAddrs'
    },
    const {
      '1': 'dry_run_internal_addrs',
      '3': 3,
      '4': 3,
      '5': 9,
      '10': 'dryRunInternalAddrs'
    },
  ],
};

/// Descriptor for `ImportAccountResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List importAccountResponseDescriptor = $convert.base64Decode(
    'ChVJbXBvcnRBY2NvdW50UmVzcG9uc2USLAoHYWNjb3VudBgBIAEoCzISLndhbGxldHJwYy5BY2NvdW50UgdhY2NvdW50EjMKFmRyeV9ydW5fZXh0ZXJuYWxfYWRkcnMYAiADKAlSE2RyeVJ1bkV4dGVybmFsQWRkcnMSMwoWZHJ5X3J1bl9pbnRlcm5hbF9hZGRycxgDIAMoCVITZHJ5UnVuSW50ZXJuYWxBZGRycw==');
...
final $typed_data.Uint8List importPublicKeyRequestDescriptor =
    $convert.base64Decode(
        'ChZJbXBvcnRQdWJsaWNLZXlSZXF1ZXN0Eh0KCnB1YmxpY19rZXkYASABKAxSCXB1YmxpY0tleRI5CgxhZGRyZXNzX3R5cGUYAiABKA4yFi53YWxsZXRycGMuQWRkcmVzc1R5cGVSC2FkZHJlc3NUeXBl');
...
final $typed_data.Uint8List importPublicKeyResponseDescriptor =
    $convert.base64Decode('ChdJbXBvcnRQdWJsaWNLZXlSZXNwb25zZQ==');
...
final $typed_data.Uint8List transactionDescriptor = $convert.base64Decode(
    'CgtUcmFuc2FjdGlvbhIVCgZ0eF9oZXgYASABKAxSBXR4SGV4EhQKBWxhYmVsGAIgASgJUgVsYWJlbA==');
...
final $typed_data.Uint8List publishResponseDescriptor = $convert.base64Decode(
    'Cg9QdWJsaXNoUmVzcG9uc2USIwoNcHVibGlzaF9lcnJvchgBIAEoCVIMcHVibGlzaEVycm9y');
...
final $typed_data.Uint8List sendOutputsRequestDescriptor = $convert.base64Decode(
    'ChJTZW5kT3V0cHV0c1JlcXVlc3QSHAoKc2F0X3Blcl9rdxgBIAEoA1IIc2F0UGVyS3cSKAoHb3V0cHV0cxgCIAMoCzIOLnNpZ25ycGMuVHhPdXRSB291dHB1dHMSFAoFbGFiZWwYAyABKAlSBWxhYmVsEhsKCW1pbl9jb25mcxgEIAEoBVIIbWluQ29uZnMSKwoRc3BlbmRfdW5jb25maXJtZWQYBSABKAhSEHNwZW5kVW5jb25maXJtZWQ=');
...
final $typed_data.Uint8List sendOutputsResponseDescriptor =
    $convert.base64Decode(
        'ChNTZW5kT3V0cHV0c1Jlc3BvbnNlEhUKBnJhd190eBgBIAEoDFIFcmF3VHg=');
...
final $typed_data.Uint8List estimateFeeRequestDescriptor = $convert.base64Decode(
    'ChJFc3RpbWF0ZUZlZVJlcXVlc3QSHwoLY29uZl90YXJnZXQYASABKAVSCmNvbmZUYXJnZXQ=');
...
final $typed_data.Uint8List estimateFeeResponseDescriptor =
    $convert.base64Decode(
        'ChNFc3RpbWF0ZUZlZVJlc3BvbnNlEhwKCnNhdF9wZXJfa3cYASABKANSCHNhdFBlckt3');
...
const PendingSweep$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 13,
      '10': 'broadcastAttempts'
    },
    const {
      '1': 'next_broadcast_height',
      '3': 6,
      '4': 1,
      '5': 13,
      '10': 'nextBroadcastHeight'
    },
    const {
      '1': 'requested_conf_target',
      '3': 8,
      '4': 1,
      '5': 13,
      '10': 'requestedConfTarget'
    },
    const {
    ...
    const {
      '1': 'requested_sat_per_vbyte',
      '3': 11,
      '4': 1,
      '5': 4,
      '10': 'requestedSatPerVbyte'
    },
...
final $typed_data.Uint8List pendingSweepDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List pendingSweepsRequestDescriptor =
    $convert.base64Decode('ChRQZW5kaW5nU3dlZXBzUmVxdWVzdA==');
...
final $typed_data.Uint8List pendingSweepsResponseDescriptor = $convert.base64Decode(
    'ChVQZW5kaW5nU3dlZXBzUmVzcG9uc2USPgoOcGVuZGluZ19zd2VlcHMYASADKAsyFy53YWxsZXRycGMuUGVuZGluZ1N3ZWVwUg1wZW5kaW5nU3dlZXBz');
...
final $typed_data.Uint8List bumpFeeRequestDescriptor = $convert.base64Decode(
    'Cg5CdW1wRmVlUmVxdWVzdBIrCghvdXRwb2ludBgBIAEoCzIPLmxucnBjLk91dFBvaW50UghvdXRwb2ludBIfCgt0YXJnZXRfY29uZhgCIAEoDVIKdGFyZ2V0Q29uZhIkCgxzYXRfcGVyX2J5dGUYAyABKA1CAhgBUgpzYXRQZXJCeXRlEhQKBWZvcmNlGAQgASgIUgVmb3JjZRIiCg1zYXRfcGVyX3ZieXRlGAUgASgEUgtzYXRQZXJWYnl0ZQ==');
...
final $typed_data.Uint8List bumpFeeResponseDescriptor =
    $convert.base64Decode('Cg9CdW1wRmVlUmVzcG9uc2U=');
...
final $typed_data.Uint8List listSweepsRequestDescriptor = $convert.base64Decode(
    'ChFMaXN0U3dlZXBzUmVxdWVzdBIYCgd2ZXJib3NlGAEgASgIUgd2ZXJib3Nl');
...
const ListSweepsResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.walletrpc.ListSweepsResponse.TransactionIDs',
      '9': 0,
      '10': 'transactionIds'
    },
  ],
...
final $typed_data.Uint8List listSweepsResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List labelTransactionRequestDescriptor =
    $convert.base64Decode(
        'ChdMYWJlbFRyYW5zYWN0aW9uUmVxdWVzdBISCgR0eGlkGAEgASgMUgR0eGlkEhQKBWxhYmVsGAIgASgJUgVsYWJlbBIcCglvdmVyd3JpdGUYAyABKAhSCW92ZXJ3cml0ZQ==');
...
final $typed_data.Uint8List labelTransactionResponseDescriptor =
    $convert.base64Decode('ChhMYWJlbFRyYW5zYWN0aW9uUmVzcG9uc2U=');
...
final $typed_data.Uint8List fundPsbtRequestDescriptor = $convert.base64Decode(
    '');
...
const FundPsbtResponse$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'change_output_index',
      '3': 2,
      '4': 1,
      '5': 5,
      '10': 'changeOutputIndex'
    },
    const {
      '1': 'locked_utxos',
      '3': 3,
...
final $typed_data.Uint8List fundPsbtResponseDescriptor = $convert.base64Decode(
    'ChBGdW5kUHNidFJlc3BvbnNlEh8KC2Z1bmRlZF9wc2J0GAEgASgMUgpmdW5kZWRQc2J0Ei4KE2NoYW5nZV9vdXRwdXRfaW5kZXgYAiABKAVSEWNoYW5nZU91dHB1dEluZGV4EjcKDGxvY2tlZF91dHhvcxgDIAMoCzIULndhbGxldHJwYy5VdHhvTGVhc2VSC2xvY2tlZFV0eG9z');
...
const TxTemplate$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.walletrpc.TxTemplate.OutputsEntry',
      '10': 'outputs'
    },
  ],
...
final $typed_data.Uint8List txTemplateDescriptor = $convert.base64Decode(
    'CgpUeFRlbXBsYXRlEicKBmlucHV0cxgBIAMoCzIPLmxucnBjLk91dFBvaW50UgZpbnB1dHMSPAoHb3V0cHV0cxgCIAMoCzIiLndhbGxldHJwYy5UeFRlbXBsYXRlLk91dHB1dHNFbnRyeVIHb3V0cHV0cxo6CgxPdXRwdXRzRW50cnkSEAoDa2V5GAEgASgJUgNrZXkSFAoFdmFsdWUYAiABKARSBXZhbHVlOgI4AQ==');
...
final $typed_data.Uint8List utxoLeaseDescriptor = $convert.base64Decode(
    'CglVdHhvTGVhc2USDgoCaWQYASABKAxSAmlkEisKCG91dHBvaW50GAIgASgLMg8ubG5ycGMuT3V0UG9pbnRSCG91dHBvaW50Eh4KCmV4cGlyYXRpb24YAyABKARSCmV4cGlyYXRpb24=');
...
final $typed_data.Uint8List signPsbtRequestDescriptor = $convert.base64Decode(
    'Cg9TaWduUHNidFJlcXVlc3QSHwoLZnVuZGVkX3BzYnQYASABKAxSCmZ1bmRlZFBzYnQ=');
...
final $typed_data.Uint8List signPsbtResponseDescriptor = $convert.base64Decode(
    'ChBTaWduUHNidFJlc3BvbnNlEh8KC3NpZ25lZF9wc2J0GAEgASgMUgpzaWduZWRQc2J0');
...
final $typed_data.Uint8List finalizePsbtRequestDescriptor = $convert.base64Decode(
    'ChNGaW5hbGl6ZVBzYnRSZXF1ZXN0Eh8KC2Z1bmRlZF9wc2J0GAEgASgMUgpmdW5kZWRQc2J0EhgKB2FjY291bnQYBSABKAlSB2FjY291bnQ=');
...
final $typed_data.Uint8List finalizePsbtResponseDescriptor = $convert.base64Decode(
    'ChRGaW5hbGl6ZVBzYnRSZXNwb25zZRIfCgtzaWduZWRfcHNidBgBIAEoDFIKc2lnbmVkUHNidBIgCgxyYXdfZmluYWxfdHgYAiABKAxSCnJhd0ZpbmFsVHg=');
...
final $typed_data.Uint8List listLeasesRequestDescriptor =
    $convert.base64Decode('ChFMaXN0TGVhc2VzUmVxdWVzdA==');
...
final $typed_data.Uint8List listLeasesResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0TGVhc2VzUmVzcG9uc2USNwoMbG9ja2VkX3V0eG9zGAEgAygLMhQud2FsbGV0cnBjLlV0eG9MZWFzZVILbG9ja2VkVXR4b3M=');
