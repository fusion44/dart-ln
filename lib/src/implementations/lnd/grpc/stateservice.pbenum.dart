...
class WalletState extends $pb.ProtobufEnum {
  static const WalletState NON_EXISTING = WalletState._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NON_EXISTING');
  static const WalletState LOCKED = WalletState._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'LOCKED');
  static const WalletState UNLOCKED = WalletState._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNLOCKED');
  static const WalletState RPC_ACTIVE = WalletState._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'RPC_ACTIVE');
  static const WalletState SERVER_ACTIVE = WalletState._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SERVER_ACTIVE');
  static const WalletState WAITING_TO_START = WalletState._(
      255,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WAITING_TO_START');
  ...
  static final $core.Map<$core.int, WalletState> _byValue =
