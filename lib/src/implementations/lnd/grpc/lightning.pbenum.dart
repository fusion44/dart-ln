...
class OutputScriptType extends $pb.ProtobufEnum {
  static const OutputScriptType SCRIPT_TYPE_PUBKEY_HASH = OutputScriptType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_TYPE_PUBKEY_HASH');
  static const OutputScriptType SCRIPT_TYPE_SCRIPT_HASH = OutputScriptType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_TYPE_SCRIPT_HASH');
  static const OutputScriptType SCRIPT_TYPE_WITNESS_V0_PUBKEY_HASH = OutputScriptType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_TYPE_WITNESS_V0_PUBKEY_HASH');
  static const OutputScriptType SCRIPT_TYPE_WITNESS_V0_SCRIPT_HASH = OutputScriptType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_TYPE_WITNESS_V0_SCRIPT_HASH');
  static const OutputScriptType SCRIPT_TYPE_PUBKEY = OutputScriptType._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_TYPE_PUBKEY');
  static const OutputScriptType SCRIPT_TYPE_MULTISIG = OutputScriptType._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_TYPE_MULTISIG');
  static const OutputScriptType SCRIPT_TYPE_NULLDATA = OutputScriptType._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_TYPE_NULLDATA');
  static const OutputScriptType SCRIPT_TYPE_NON_STANDARD = OutputScriptType._(7, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_TYPE_NON_STANDARD');
  static const OutputScriptType SCRIPT_TYPE_WITNESS_UNKNOWN = OutputScriptType._(8, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_TYPE_WITNESS_UNKNOWN');
...
class AddressType extends $pb.ProtobufEnum {
  ...
  static const AddressType TAPROOT_PUBKEY = AddressType._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TAPROOT_PUBKEY');
  static const AddressType UNUSED_TAPROOT_PUBKEY = AddressType._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNUSED_TAPROOT_PUBKEY');
...
class CommitmentType extends $pb.ProtobufEnum {
  static const CommitmentType UNKNOWN_COMMITMENT_TYPE = CommitmentType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN_COMMITMENT_TYPE');
  static const CommitmentType LEGACY = CommitmentType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LEGACY');
  static const CommitmentType STATIC_REMOTE_KEY = CommitmentType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STATIC_REMOTE_KEY');
  static const CommitmentType ANCHORS = CommitmentType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ANCHORS');
  static const CommitmentType SCRIPT_ENFORCED_LEASE = CommitmentType._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCRIPT_ENFORCED_LEASE');
...
class FeatureBit extends $pb.ProtobufEnum {
  ...
  static const FeatureBit AMP_REQ = FeatureBit._(30, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AMP_REQ');
  static const FeatureBit AMP_OPT = FeatureBit._(31, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AMP_OPT');
...
class UpdateFailure extends $pb.ProtobufEnum {
  static const UpdateFailure UPDATE_FAILURE_UNKNOWN = UpdateFailure._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UPDATE_FAILURE_UNKNOWN');
  static const UpdateFailure UPDATE_FAILURE_PENDING = UpdateFailure._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UPDATE_FAILURE_PENDING');
  static const UpdateFailure UPDATE_FAILURE_NOT_FOUND = UpdateFailure._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UPDATE_FAILURE_NOT_FOUND');
  static const UpdateFailure UPDATE_FAILURE_INTERNAL_ERR = UpdateFailure._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UPDATE_FAILURE_INTERNAL_ERR');
  static const UpdateFailure UPDATE_FAILURE_INVALID_PARAMETER = UpdateFailure._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UPDATE_FAILURE_INVALID_PARAMETER');
  ...
  const UpdateFailure._($core.int v, $core.String n) : super(v, n);
}
...
class ChannelEventUpdate_UpdateType extends $pb.ProtobufEnum {
  ...
  static const ChannelEventUpdate_UpdateType FULLY_RESOLVED_CHANNEL = ChannelEventUpdate_UpdateType._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FULLY_RESOLVED_CHANNEL');
...
class Failure_FailureCode extends $pb.ProtobufEnum {
  ...
  static const Failure_FailureCode INVALID_ONION_PAYLOAD = Failure_FailureCode._(24, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INVALID_ONION_PAYLOAD');
