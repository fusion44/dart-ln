...
const OutputScriptType$json = const {
  '1': 'OutputScriptType',
  '2': const [
    const {'1': 'SCRIPT_TYPE_PUBKEY_HASH', '2': 0},
    const {'1': 'SCRIPT_TYPE_SCRIPT_HASH', '2': 1},
    const {'1': 'SCRIPT_TYPE_WITNESS_V0_PUBKEY_HASH', '2': 2},
    const {'1': 'SCRIPT_TYPE_WITNESS_V0_SCRIPT_HASH', '2': 3},
    const {'1': 'SCRIPT_TYPE_PUBKEY', '2': 4},
    const {'1': 'SCRIPT_TYPE_MULTISIG', '2': 5},
    const {'1': 'SCRIPT_TYPE_NULLDATA', '2': 6},
    const {'1': 'SCRIPT_TYPE_NON_STANDARD', '2': 7},
    const {'1': 'SCRIPT_TYPE_WITNESS_UNKNOWN', '2': 8},
  ],
};

/// Descriptor for `OutputScriptType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List outputScriptTypeDescriptor = $convert.base64Decode('');
...
const AddressType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'TAPROOT_PUBKEY', '2': 4},
    const {'1': 'UNUSED_TAPROOT_PUBKEY', '2': 5},
  ],
};

/// Descriptor for `AddressType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List addressTypeDescriptor = $convert.base64Decode('CgtBZGRyZXNzVHlwZRIXChNXSVRORVNTX1BVQktFWV9IQVNIEAASFgoSTkVTVEVEX1BVQktFWV9IQVNIEAESHgoaVU5VU0VEX1dJVE5FU1NfUFVCS0VZX0hBU0gQAhIdChlVTlVTRURfTkVTVEVEX1BVQktFWV9IQVNIEAMSEgoOVEFQUk9PVF9QVUJLRVkQBBIZChVVTlVTRURfVEFQUk9PVF9QVUJLRVkQBQ==');
...
const OutputDetail$json = const {
  '1': 'OutputDetail',
  '2': const [
    const {'1': 'output_type', '3': 1, '4': 1, '5': 14, '6': '.lnrpc.OutputScriptType', '10': 'outputType'},
    const {'1': 'address', '3': 2, '4': 1, '5': 9, '10': 'address'},
    const {'1': 'pk_script', '3': 3, '4': 1, '5': 9, '10': 'pkScript'},
    const {'1': 'output_index', '3': 4, '4': 1, '5': 3, '10': 'outputIndex'},
    const {'1': 'amount', '3': 5, '4': 1, '5': 3, '10': 'amount'},
    const {'1': 'is_our_address', '3': 6, '4': 1, '5': 8, '10': 'isOurAddress'},
  ],
};

/// Descriptor for `OutputDetail`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List outputDetailDescriptor = $convert.base64Decode('');
...
const Transaction$json = const {
  ...
  '2': const [
    ...
    const {'1': 'output_details', '3': 11, '4': 3, '5': 11, '6': '.lnrpc.OutputDetail', '10': 'outputDetails'},
...
final $typed_data.Uint8List transactionDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List sendRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List closeChannelRequestDescriptor = $convert.base64Decode('');
...
const BatchOpenChannel$json = const {
  ...
  '2': const [
    const {'1': 'node_pubkey', '3': 1, '4': 1, '5': 12, '10': 'nodePubkey'},
    const {'1': 'local_funding_amount', '3': 2, '4': 1, '5': 3, '10': 'localFundingAmount'},
    const {'1': 'push_sat', '3': 3, '4': 1, '5': 3, '10': 'pushSat'},
...
final $typed_data.Uint8List batchOpenChannelDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List openChannelRequestDescriptor = $convert.base64Decode('');
...
const PendingChannelsResponse_PendingChannel$json = const {
  ...
  '2': const [
    ...
    const {'1': 'private', '3': 12, '4': 1, '5': 8, '10': 'private'},
  ],
};
...
final $typed_data.Uint8List pendingChannelsResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List channelEventUpdateDescriptor = $convert.base64Decode('');
...
const WalletBalanceResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'locked_balance', '3': 5, '4': 1, '5': 3, '10': 'lockedBalance'},
...
final $typed_data.Uint8List walletBalanceResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List invoiceDescriptor = $convert.base64Decode('');
