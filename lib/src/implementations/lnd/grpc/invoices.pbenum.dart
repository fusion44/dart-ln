...
class LookupModifier extends $pb.ProtobufEnum {
  static const LookupModifier DEFAULT = LookupModifier._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DEFAULT');
  static const LookupModifier HTLC_SET_ONLY = LookupModifier._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'HTLC_SET_ONLY');
  static const LookupModifier HTLC_SET_BLANK = LookupModifier._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'HTLC_SET_BLANK');
  ...
  static final $core.Map<$core.int, LookupModifier> _byValue =
