...
final $typed_data.Uint8List statusResponseDescriptor = $convert
    .base64Decode('Cg5TdGF0dXNSZXNwb25zZRIWCgZhY3RpdmUYASABKAhSBmFjdGl2ZQ==');
...
final $typed_data.Uint8List modifyStatusRequestDescriptor =
    $convert.base64Decode(
        'ChNNb2RpZnlTdGF0dXNSZXF1ZXN0EhYKBmVuYWJsZRgBIAEoCFIGZW5hYmxl');
...
final $typed_data.Uint8List modifyStatusResponseDescriptor =
    $convert.base64Decode('ChRNb2RpZnlTdGF0dXNSZXNwb25zZQ==');
...
final $typed_data.Uint8List queryScoresRequestDescriptor = $convert.base64Decode(
    'ChJRdWVyeVNjb3Jlc1JlcXVlc3QSGAoHcHVia2V5cxgBIAMoCVIHcHVia2V5cxIsChJpZ25vcmVfbG9jYWxfc3RhdGUYAiABKAhSEGlnbm9yZUxvY2FsU3RhdGU=');
...
const QueryScoresResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.autopilotrpc.QueryScoresResponse.HeuristicResult',
      '10': 'results'
    },
  ],
...
const QueryScoresResponse_HeuristicResult$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.autopilotrpc.QueryScoresResponse.HeuristicResult.ScoresEntry',
      '10': 'scores'
    },
  ],
...
final $typed_data.Uint8List queryScoresResponseDescriptor = $convert.base64Decode(
    '');
...
const SetScoresRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.autopilotrpc.SetScoresRequest.ScoresEntry',
      '10': 'scores'
    },
  ],
...
final $typed_data.Uint8List setScoresRequestDescriptor = $convert.base64Decode(
    'ChBTZXRTY29yZXNSZXF1ZXN0EhwKCWhldXJpc3RpYxgBIAEoCVIJaGV1cmlzdGljEkIKBnNjb3JlcxgCIAMoCzIqLmF1dG9waWxvdHJwYy5TZXRTY29yZXNSZXF1ZXN0LlNjb3Jlc0VudHJ5UgZzY29yZXMaOQoLU2NvcmVzRW50cnkSEAoDa2V5GAEgASgJUgNrZXkSFAoFdmFsdWUYAiABKAFSBXZhbHVlOgI4AQ==');
...
final $typed_data.Uint8List setScoresResponseDescriptor =
    $convert.base64Decode('ChFTZXRTY29yZXNSZXNwb25zZQ==');
