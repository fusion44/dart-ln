...
final $typed_data.Uint8List keyLocatorDescriptor = $convert.base64Decode(
    'CgpLZXlMb2NhdG9yEh0KCmtleV9mYW1pbHkYASABKAVSCWtleUZhbWlseRIbCglrZXlfaW5kZXgYAiABKAVSCGtleUluZGV4');
...
final $typed_data.Uint8List keyDescriptorDescriptor = $convert.base64Decode(
    'Cg1LZXlEZXNjcmlwdG9yEiIKDXJhd19rZXlfYnl0ZXMYASABKAxSC3Jhd0tleUJ5dGVzEiwKB2tleV9sb2MYAiABKAsyEy5zaWducnBjLktleUxvY2F0b3JSBmtleUxvYw==');
...
final $typed_data.Uint8List txOutDescriptor = $convert.base64Decode(
    'CgVUeE91dBIUCgV2YWx1ZRgBIAEoA1IFdmFsdWUSGwoJcGtfc2NyaXB0GAIgASgMUghwa1NjcmlwdA==');
...
final $typed_data.Uint8List signDescriptorDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signReqDescriptor = $convert.base64Decode(
    'CgdTaWduUmVxEiAKDHJhd190eF9ieXRlcxgBIAEoDFIKcmF3VHhCeXRlcxI2CgpzaWduX2Rlc2NzGAIgAygLMhcuc2lnbnJwYy5TaWduRGVzY3JpcHRvclIJc2lnbkRlc2NzEjEKDHByZXZfb3V0cHV0cxgDIAMoCzIOLnNpZ25ycGMuVHhPdXRSC3ByZXZPdXRwdXRz');
...
final $typed_data.Uint8List signRespDescriptor = $convert
    .base64Decode('CghTaWduUmVzcBIZCghyYXdfc2lncxgBIAMoDFIHcmF3U2lncw==');
...
final $typed_data.Uint8List inputScriptDescriptor = $convert.base64Decode(
    'CgtJbnB1dFNjcmlwdBIYCgd3aXRuZXNzGAEgAygMUgd3aXRuZXNzEh0KCnNpZ19zY3JpcHQYAiABKAxSCXNpZ1NjcmlwdA==');
...
final $typed_data.Uint8List inputScriptRespDescriptor = $convert.base64Decode(
    'Cg9JbnB1dFNjcmlwdFJlc3ASOQoNaW5wdXRfc2NyaXB0cxgBIAMoCzIULnNpZ25ycGMuSW5wdXRTY3JpcHRSDGlucHV0U2NyaXB0cw==');
...
const SignMessageReq$json = const {
  ...
  '2': const [
    ...
    const {'1': 'double_hash', '3': 3, '4': 1, '5': 8, '10': 'doubleHash'},
    const {'1': 'compact_sig', '3': 4, '4': 1, '5': 8, '10': 'compactSig'},
  ],
};
...
final $typed_data.Uint8List signMessageReqDescriptor = $convert.base64Decode(
    'Cg5TaWduTWVzc2FnZVJlcRIQCgNtc2cYASABKAxSA21zZxIsCgdrZXlfbG9jGAIgASgLMhMuc2lnbnJwYy5LZXlMb2NhdG9yUgZrZXlMb2MSHwoLZG91YmxlX2hhc2gYAyABKAhSCmRvdWJsZUhhc2gSHwoLY29tcGFjdF9zaWcYBCABKAhSCmNvbXBhY3RTaWc=');
...
final $typed_data.Uint8List verifyMessageReqDescriptor = $convert.base64Decode(
    'ChBWZXJpZnlNZXNzYWdlUmVxEhAKA21zZxgBIAEoDFIDbXNnEhwKCXNpZ25hdHVyZRgCIAEoDFIJc2lnbmF0dXJlEhYKBnB1YmtleRgDIAEoDFIGcHVia2V5');
...
final $typed_data.Uint8List verifyMessageRespDescriptor = $convert
    .base64Decode('ChFWZXJpZnlNZXNzYWdlUmVzcBIUCgV2YWxpZBgBIAEoCFIFdmFsaWQ=');
...
final $typed_data.Uint8List sharedKeyRequestDescriptor = $convert.base64Decode(
    'ChBTaGFyZWRLZXlSZXF1ZXN0EikKEGVwaGVtZXJhbF9wdWJrZXkYASABKAxSD2VwaGVtZXJhbFB1YmtleRIwCgdrZXlfbG9jGAIgASgLMhMuc2lnbnJwYy5LZXlMb2NhdG9yQgIYAVIGa2V5TG9jEjEKCGtleV9kZXNjGAMgASgLMhYuc2lnbnJwYy5LZXlEZXNjcmlwdG9yUgdrZXlEZXNj');
