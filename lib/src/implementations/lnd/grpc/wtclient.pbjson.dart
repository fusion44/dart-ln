...
final $typed_data.Uint8List policyTypeDescriptor =
    $convert.base64Decode('CgpQb2xpY3lUeXBlEgoKBkxFR0FDWRAAEgoKBkFOQ0hPUhAB');
...
final $typed_data.Uint8List addTowerRequestDescriptor = $convert.base64Decode(
    'Cg9BZGRUb3dlclJlcXVlc3QSFgoGcHVia2V5GAEgASgMUgZwdWJrZXkSGAoHYWRkcmVzcxgCIAEoCVIHYWRkcmVzcw==');
...
final $typed_data.Uint8List addTowerResponseDescriptor =
    $convert.base64Decode('ChBBZGRUb3dlclJlc3BvbnNl');
...
final $typed_data.Uint8List removeTowerRequestDescriptor = $convert.base64Decode(
    'ChJSZW1vdmVUb3dlclJlcXVlc3QSFgoGcHVia2V5GAEgASgMUgZwdWJrZXkSGAoHYWRkcmVzcxgCIAEoCVIHYWRkcmVzcw==');
...
final $typed_data.Uint8List removeTowerResponseDescriptor =
    $convert.base64Decode('ChNSZW1vdmVUb3dlclJlc3BvbnNl');
...
final $typed_data.Uint8List getTowerInfoRequestDescriptor = $convert.base64Decode(
    'ChNHZXRUb3dlckluZm9SZXF1ZXN0EhYKBnB1YmtleRgBIAEoDFIGcHVia2V5EikKEGluY2x1ZGVfc2Vzc2lvbnMYAiABKAhSD2luY2x1ZGVTZXNzaW9ucw==');
...
const TowerSession$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'num_pending_backups',
      '3': 2,
      '4': 1,
      '5': 13,
      '10': 'numPendingBackups'
    },
    const {'1': 'max_backups', '3': 3, '4': 1, '5': 13, '10': 'maxBackups'},
    const {
      '1': 'sweep_sat_per_byte',
      '3': 4,
      '4': 1,
      '5': 13,
      '8': const {'3': true},
...
final $typed_data.Uint8List towerSessionDescriptor = $convert.base64Decode(
    '');
...
const Tower$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'active_session_candidate',
      '3': 3,
      '4': 1,
      '5': 8,
      '10': 'activeSessionCandidate'
    },
...
final $typed_data.Uint8List towerDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listTowersRequestDescriptor = $convert.base64Decode(
    'ChFMaXN0VG93ZXJzUmVxdWVzdBIpChBpbmNsdWRlX3Nlc3Npb25zGAEgASgIUg9pbmNsdWRlU2Vzc2lvbnM=');
...
final $typed_data.Uint8List listTowersResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0VG93ZXJzUmVzcG9uc2USKgoGdG93ZXJzGAEgAygLMhIud3RjbGllbnRycGMuVG93ZXJSBnRvd2Vycw==');
...
const StatsResponse$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'num_sessions_acquired',
      '3': 4,
      '4': 1,
      '5': 13,
      '10': 'numSessionsAcquired'
    },
    const {
      '1': 'num_sessions_exhausted',
      '3': 5,
      '4': 1,
      '5': 13,
      '10': 'numSessionsExhausted'
    },
  ],
};
...
final $typed_data.Uint8List statsResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List policyRequestDescriptor = $convert.base64Decode(
    'Cg1Qb2xpY3lSZXF1ZXN0EjgKC3BvbGljeV90eXBlGAEgASgOMhcud3RjbGllbnRycGMuUG9saWN5VHlwZVIKcG9saWN5VHlwZQ==');
...
final $typed_data.Uint8List policyResponseDescriptor = $convert.base64Decode(
    'Cg5Qb2xpY3lSZXNwb25zZRIfCgttYXhfdXBkYXRlcxgBIAEoDVIKbWF4VXBkYXRlcxIvChJzd2VlcF9zYXRfcGVyX2J5dGUYAiABKA1CAhgBUg9zd2VlcFNhdFBlckJ5dGUSLQoTc3dlZXBfc2F0X3Blcl92Ynl0ZRgDIAEoDVIQc3dlZXBTYXRQZXJWYnl0ZQ==');
