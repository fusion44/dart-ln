...
final $typed_data.Uint8List failureDetailDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List paymentStateDescriptor = $convert.base64Decode(
    'CgxQYXltZW50U3RhdGUSDQoJSU5fRkxJR0hUEAASDQoJU1VDQ0VFREVEEAESEgoORkFJTEVEX1RJTUVPVVQQAhITCg9GQUlMRURfTk9fUk9VVEUQAxIQCgxGQUlMRURfRVJST1IQBBIkCiBGQUlMRURfSU5DT1JSRUNUX1BBWU1FTlRfREVUQUlMUxAFEh8KG0ZBSUxFRF9JTlNVRkZJQ0lFTlRfQkFMQU5DRRAG');
...
final $typed_data.Uint8List resolveHoldForwardActionDescriptor =
    $convert.base64Decode(
        'ChhSZXNvbHZlSG9sZEZvcndhcmRBY3Rpb24SCgoGU0VUVExFEAASCAoERkFJTBABEgoKBlJFU1VNRRAC');
@$core.Deprecated('Use chanStatusActionDescriptor instead')
const ChanStatusAction$json = const {
  '1': 'ChanStatusAction',
  '2': const [
    const {'1': 'ENABLE', '2': 0},
    const {'1': 'DISABLE', '2': 1},
...
const SendPaymentRequest$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'no_inflight_updates',
      '3': 18,
      '4': 1,
      '5': 8,
      '10': 'noInflightUpdates'
    },
    const {
      '1': 'max_shard_size_msat',
      '3': 21,
      '4': 1,
      '5': 4,
      '10': 'maxShardSizeMsat'
    },
    const {'1': 'amp', '3': 22, '4': 1, '5': 8, '10': 'amp'},
  ],
...
final $typed_data.Uint8List sendPaymentRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List trackPaymentRequestDescriptor = $convert.base64Decode(
    'ChNUcmFja1BheW1lbnRSZXF1ZXN0EiEKDHBheW1lbnRfaGFzaBgBIAEoDFILcGF5bWVudEhhc2gSLgoTbm9faW5mbGlnaHRfdXBkYXRlcxgCIAEoCFIRbm9JbmZsaWdodFVwZGF0ZXM=');
...
final $typed_data.Uint8List routeFeeRequestDescriptor = $convert.base64Decode(
    'Cg9Sb3V0ZUZlZVJlcXVlc3QSEgoEZGVzdBgBIAEoDFIEZGVzdBIXCgdhbXRfc2F0GAIgASgDUgZhbXRTYXQ=');
...
final $typed_data.Uint8List routeFeeResponseDescriptor = $convert.base64Decode(
    'ChBSb3V0ZUZlZVJlc3BvbnNlEigKEHJvdXRpbmdfZmVlX21zYXQYASABKANSDnJvdXRpbmdGZWVNc2F0EiYKD3RpbWVfbG9ja19kZWxheRgCIAEoA1INdGltZUxvY2tEZWxheQ==');
...
final $typed_data.Uint8List sendToRouteRequestDescriptor = $convert.base64Decode(
    'ChJTZW5kVG9Sb3V0ZVJlcXVlc3QSIQoMcGF5bWVudF9oYXNoGAEgASgMUgtwYXltZW50SGFzaBIiCgVyb3V0ZRgCIAEoCzIMLmxucnBjLlJvdXRlUgVyb3V0ZQ==');
...
final $typed_data.Uint8List sendToRouteResponseDescriptor = $convert.base64Decode(
    'ChNTZW5kVG9Sb3V0ZVJlc3BvbnNlEhoKCHByZWltYWdlGAEgASgMUghwcmVpbWFnZRIoCgdmYWlsdXJlGAIgASgLMg4ubG5ycGMuRmFpbHVyZVIHZmFpbHVyZQ==');
...
final $typed_data.Uint8List resetMissionControlRequestDescriptor =
    $convert.base64Decode('ChpSZXNldE1pc3Npb25Db250cm9sUmVxdWVzdA==');
...
final $typed_data.Uint8List resetMissionControlResponseDescriptor =
    $convert.base64Decode('ChtSZXNldE1pc3Npb25Db250cm9sUmVzcG9uc2U=');
...
final $typed_data.Uint8List queryMissionControlRequestDescriptor =
    $convert.base64Decode('ChpRdWVyeU1pc3Npb25Db250cm9sUmVxdWVzdA==');
...
final $typed_data.Uint8List queryMissionControlResponseDescriptor =
    $convert.base64Decode(
        'ChtRdWVyeU1pc3Npb25Db250cm9sUmVzcG9uc2USLAoFcGFpcnMYAiADKAsyFi5yb3V0ZXJycGMuUGFpckhpc3RvcnlSBXBhaXJzSgQIARAC');
@$core.Deprecated('Use xImportMissionControlRequestDescriptor instead')
const XImportMissionControlRequest$json = const {
...
final $typed_data.Uint8List xImportMissionControlRequestDescriptor =
    $convert.base64Decode(
        'ChxYSW1wb3J0TWlzc2lvbkNvbnRyb2xSZXF1ZXN0EiwKBXBhaXJzGAEgAygLMhYucm91dGVycnBjLlBhaXJIaXN0b3J5UgVwYWlycxIUCgVmb3JjZRgCIAEoCFIFZm9yY2U=');
@$core.Deprecated('Use xImportMissionControlResponseDescriptor instead')
const XImportMissionControlResponse$json = const {
  '1': 'XImportMissionControlResponse',
};

/// Descriptor for `XImportMissionControlResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List xImportMissionControlResponseDescriptor =
    $convert.base64Decode('Ch1YSW1wb3J0TWlzc2lvbkNvbnRyb2xSZXNwb25zZQ==');
...
final $typed_data.Uint8List pairHistoryDescriptor = $convert.base64Decode(
    'CgtQYWlySGlzdG9yeRIbCglub2RlX2Zyb20YASABKAxSCG5vZGVGcm9tEhcKB25vZGVfdG8YAiABKAxSBm5vZGVUbxItCgdoaXN0b3J5GAcgASgLMhMucm91dGVycnBjLlBhaXJEYXRhUgdoaXN0b3J5SgQIAxAESgQIBBAFSgQIBRAGSgQIBhAH');
...
final $typed_data.Uint8List pairDataDescriptor = $convert.base64Decode(
    '');
@$core.Deprecated('Use getMissionControlConfigRequestDescriptor instead')
const GetMissionControlConfigRequest$json = const {
...
final $typed_data.Uint8List getMissionControlConfigRequestDescriptor =
    $convert.base64Decode('Ch5HZXRNaXNzaW9uQ29udHJvbENvbmZpZ1JlcXVlc3Q=');
@$core.Deprecated('Use getMissionControlConfigResponseDescriptor instead')
const GetMissionControlConfigResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.routerrpc.MissionControlConfig',
      '10': 'config'
    },
  ],
};
...
final $typed_data.Uint8List getMissionControlConfigResponseDescriptor =
    $convert.base64Decode(
        'Ch9HZXRNaXNzaW9uQ29udHJvbENvbmZpZ1Jlc3BvbnNlEjcKBmNvbmZpZxgBIAEoCzIfLnJvdXRlcnJwYy5NaXNzaW9uQ29udHJvbENvbmZpZ1IGY29uZmln');
@$core.Deprecated('Use setMissionControlConfigRequestDescriptor instead')
const SetMissionControlConfigRequest$json = const {
...
final $typed_data.Uint8List setMissionControlConfigRequestDescriptor =
    $convert.base64Decode(
        'Ch5TZXRNaXNzaW9uQ29udHJvbENvbmZpZ1JlcXVlc3QSNwoGY29uZmlnGAEgASgLMh8ucm91dGVycnBjLk1pc3Npb25Db250cm9sQ29uZmlnUgZjb25maWc=');
@$core.Deprecated('Use setMissionControlConfigResponseDescriptor instead')
const SetMissionControlConfigResponse$json = const {
...
final $typed_data.Uint8List setMissionControlConfigResponseDescriptor =
    $convert.base64Decode('Ch9TZXRNaXNzaW9uQ29udHJvbENvbmZpZ1Jlc3BvbnNl');
@$core.Deprecated('Use missionControlConfigDescriptor instead')
const MissionControlConfig$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'maximum_payment_results',
      '3': 4,
      '4': 1,
      '5': 13,
      '10': 'maximumPaymentResults'
    },
    const {
      '1': 'minimum_failure_relax_interval',
      '3': 5,
      '4': 1,
      '5': 4,
      '10': 'minimumFailureRelaxInterval'
    },
  ],
};
...
final $typed_data.Uint8List missionControlConfigDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List queryProbabilityRequestDescriptor =
    $convert.base64Decode(
        'ChdRdWVyeVByb2JhYmlsaXR5UmVxdWVzdBIbCglmcm9tX25vZGUYASABKAxSCGZyb21Ob2RlEhcKB3RvX25vZGUYAiABKAxSBnRvTm9kZRIZCghhbXRfbXNhdBgDIAEoA1IHYW10TXNhdA==');
...
final $typed_data.Uint8List queryProbabilityResponseDescriptor =
    $convert.base64Decode(
        'ChhRdWVyeVByb2JhYmlsaXR5UmVzcG9uc2USIAoLcHJvYmFiaWxpdHkYASABKAFSC3Byb2JhYmlsaXR5Ei0KB2hpc3RvcnkYAiABKAsyEy5yb3V0ZXJycGMuUGFpckRhdGFSB2hpc3Rvcnk=');
...
final $typed_data.Uint8List buildRouteRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List buildRouteResponseDescriptor = $convert.base64Decode(
    'ChJCdWlsZFJvdXRlUmVzcG9uc2USIgoFcm91dGUYASABKAsyDC5sbnJwYy5Sb3V0ZVIFcm91dGU=');
...
final $typed_data.Uint8List subscribeHtlcEventsRequestDescriptor =
    $convert.base64Decode('ChpTdWJzY3JpYmVIdGxjRXZlbnRzUmVxdWVzdA==');
@$core.Deprecated('Use htlcEventDescriptor instead')
const HtlcEvent$json = const {
  '1': 'HtlcEvent',
  '2': const [
    const {
      '1': 'incoming_channel_id',
      '3': 1,
      '4': 1,
      '5': 4,
      '10': 'incomingChannelId'
    },
    const {
      '1': 'outgoing_channel_id',
      '3': 2,
      '4': 1,
      '5': 4,
      '10': 'outgoingChannelId'
    },
    const {
      '1': 'incoming_htlc_id',
      '3': 3,
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.routerrpc.HtlcEvent.EventType',
      '10': 'eventType'
    },
    const {
      '1': 'forward_event',
      ...
      '4': 1,
      '5': 11,
      '6': '.routerrpc.ForwardEvent',
      '9': 0,
      '10': 'forwardEvent'
    },
    const {
      '1': 'forward_fail_event',
      '3': 8,
      '4': 1,
      '5': 11,
      '6': '.routerrpc.ForwardFailEvent',
      '9': 0,
      '10': 'forwardFailEvent'
    },
    const {
...
final $typed_data.Uint8List htlcInfoDescriptor = $convert.base64Decode(
    'CghIdGxjSW5mbxIrChFpbmNvbWluZ190aW1lbG9jaxgBIAEoDVIQaW5jb21pbmdUaW1lbG9jaxIrChFvdXRnb2luZ190aW1lbG9jaxgCIAEoDVIQb3V0Z29pbmdUaW1lbG9jaxIqChFpbmNvbWluZ19hbXRfbXNhdBgDIAEoBFIPaW5jb21pbmdBbXRNc2F0EioKEW91dGdvaW5nX2FtdF9tc2F0GAQgASgEUg9vdXRnb2luZ0FtdE1zYXQ=');
...
final $typed_data.Uint8List forwardFailEventDescriptor =
    $convert.base64Decode('ChBGb3J3YXJkRmFpbEV2ZW50');
...
final $typed_data.Uint8List settleEventDescriptor = $convert
    .base64Decode('CgtTZXR0bGVFdmVudBIaCghwcmVpbWFnZRgBIAEoDFIIcHJlaW1hZ2U=');
...
final $typed_data.Uint8List linkFailEventDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List paymentStatusDescriptor = $convert.base64Decode(
    'Cg1QYXltZW50U3RhdHVzEi0KBXN0YXRlGAEgASgOMhcucm91dGVycnBjLlBheW1lbnRTdGF0ZVIFc3RhdGUSGgoIcHJlaW1hZ2UYAiABKAxSCHByZWltYWdlEigKBWh0bGNzGAQgAygLMhIubG5ycGMuSFRMQ0F0dGVtcHRSBWh0bGNzSgQIAxAE');
...
final $typed_data.Uint8List circuitKeyDescriptor = $convert.base64Decode(
    'CgpDaXJjdWl0S2V5EhcKB2NoYW5faWQYASABKARSBmNoYW5JZBIXCgdodGxjX2lkGAIgASgEUgZodGxjSWQ=');
...
const ForwardHtlcInterceptRequest$json = const {
  ...
  '2': const [
    const {
      '1': 'incoming_circuit_key',
      '3': 1,
      '4': 1,
      '5': 11,
      '6': '.routerrpc.CircuitKey',
      '10': 'incomingCircuitKey'
    },
    const {
      '1': 'incoming_amount_msat',
      '3': 5,
      '4': 1,
      '5': 4,
      '10': 'incomingAmountMsat'
    },
    const {
      '1': 'incoming_expiry',
      '3': 6,
    ...
    const {
      '1': 'outgoing_requested_chan_id',
      '3': 7,
      '4': 1,
      '5': 4,
      '10': 'outgoingRequestedChanId'
    },
    const {
      '1': 'outgoing_amount_msat',
      '3': 3,
      '4': 1,
      '5': 4,
      '10': 'outgoingAmountMsat'
    },
    const {
      '1': 'outgoing_expiry',
      '3': 4,
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.routerrpc.ForwardHtlcInterceptRequest.CustomRecordsEntry',
      '10': 'customRecords'
    },
...
final $typed_data.Uint8List forwardHtlcInterceptRequestDescriptor =
    $convert.base64Decode(
        '');
...
const ForwardHtlcInterceptResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.routerrpc.ResolveHoldForwardAction',
      '10': 'action'
    },
...
final $typed_data.Uint8List forwardHtlcInterceptResponseDescriptor =
    $convert.base64Decode(
        '');
@$core.Deprecated('Use updateChanStatusRequestDescriptor instead')
const UpdateChanStatusRequest$json = const {
...
final $typed_data.Uint8List updateChanStatusRequestDescriptor =
    $convert.base64Decode(
        'ChdVcGRhdGVDaGFuU3RhdHVzUmVxdWVzdBIyCgpjaGFuX3BvaW50GAEgASgLMhMubG5ycGMuQ2hhbm5lbFBvaW50UgljaGFuUG9pbnQSMwoGYWN0aW9uGAIgASgOMhsucm91dGVycnBjLkNoYW5TdGF0dXNBY3Rpb25SBmFjdGlvbg==');
@$core.Deprecated('Use updateChanStatusResponseDescriptor instead')
const UpdateChanStatusResponse$json = const {
  '1': 'UpdateChanStatusResponse',
};

/// Descriptor for `UpdateChanStatusResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateChanStatusResponseDescriptor =
    $convert.base64Decode('ChhVcGRhdGVDaGFuU3RhdHVzUmVzcG9uc2U=');
