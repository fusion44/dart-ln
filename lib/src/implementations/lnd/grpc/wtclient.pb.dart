...
class TowerSession extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TowerSession', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'wtclientrpc'), createEmptyInstance: create)
    ...
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sweepSatPerVbyte', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (sweepSatPerVbyte != null) {
      _result.sweepSatPerVbyte = sweepSatPerVbyte;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(5)
  $core.int get sweepSatPerVbyte => $_getIZ(4);
  @$pb.TagNumber(5)
  set sweepSatPerVbyte($core.int v) { $_setUnsignedInt32(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasSweepSatPerVbyte() => $_has(4);
  @$pb.TagNumber(5)
  void clearSweepSatPerVbyte() => clearField(5);
}
...
class PolicyResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'wtclientrpc'), createEmptyInstance: create)
    ...
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sweepSatPerVbyte', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.int get sweepSatPerVbyte => $_getIZ(2);
  @$pb.TagNumber(3)
  set sweepSatPerVbyte($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasSweepSatPerVbyte() => $_has(2);
  @$pb.TagNumber(3)
  void clearSweepSatPerVbyte() => clearField(3);
}
