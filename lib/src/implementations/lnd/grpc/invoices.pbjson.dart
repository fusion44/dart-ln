...
final $typed_data.Uint8List lookupModifierDescriptor = $convert.base64Decode(
    'Cg5Mb29rdXBNb2RpZmllchILCgdERUZBVUxUEAASEQoNSFRMQ19TRVRfT05MWRABEhIKDkhUTENfU0VUX0JMQU5LEAI=');
...
final $typed_data.Uint8List cancelInvoiceRespDescriptor =
    $convert.base64Decode('ChFDYW5jZWxJbnZvaWNlUmVzcA==');
...
final $typed_data.Uint8List addHoldInvoiceRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List addHoldInvoiceRespDescriptor = $convert.base64Decode(
    'ChJBZGRIb2xkSW52b2ljZVJlc3ASJwoPcGF5bWVudF9yZXF1ZXN0GAEgASgJUg5wYXltZW50UmVxdWVzdBIbCglhZGRfaW5kZXgYAiABKARSCGFkZEluZGV4EiEKDHBheW1lbnRfYWRkchgDIAEoDFILcGF5bWVudEFkZHI=');
...
final $typed_data.Uint8List settleInvoiceRespDescriptor =
    $convert.base64Decode('ChFTZXR0bGVJbnZvaWNlUmVzcA==');
...
final $typed_data.Uint8List subscribeSingleInvoiceRequestDescriptor =
    $convert.base64Decode(
        'Ch1TdWJzY3JpYmVTaW5nbGVJbnZvaWNlUmVxdWVzdBIVCgZyX2hhc2gYAiABKAxSBXJIYXNoSgQIARAC');
...
final $typed_data.Uint8List lookupInvoiceMsgDescriptor = $convert.base64Decode(
    '');
